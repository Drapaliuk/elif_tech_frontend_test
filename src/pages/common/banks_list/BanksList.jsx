...
export function BanksList({banks, userRole, isCreatingBank, createBankHandler}) {
        ...
        <div className = 'banks-list'>
            <article className = 'bank'>
                        <AiFillBank className = 'bank__logo-icon' />
                    {
                        isAdmin 
                            ?
                        <NavLink to = '/bank/management-services' className = 'bank__settings'>
                            <IoSettingsOutline className = 'bank__settings-icon' />
                        </NavLink>
                            :
                        <NavLink to = '/bank/services' className = 'bank__settings'>
